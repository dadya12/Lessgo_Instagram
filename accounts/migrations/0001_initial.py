    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('info', models.TextField(blank=True, max_length=500, null=True, verbose_name='Info')),
                ('phone', models.CharField(blank=True, max_length=20, null=True, verbose_name='Phone Number')),
                ('gender', models.CharField(blank=True, choices=[('Male', 'Мужчина'), ('Female', 'Женщина'), ('Other', 'Другое')], max_length=20, null=True, verbose_name='Gender')),
